          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4 pt-2">
              {[Facebook, Twitter, Linkedin, Instagram].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-slate-500 hover:bg-white hover:text-cyan-600 transition-all duration-300 border border-slate-200 shadow-sm hover:scale-110 hover:shadow-md">
                  <Icon size={18} />
                </a>
              ))}
            </div>
