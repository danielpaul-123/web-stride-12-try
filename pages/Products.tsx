...
const products: Product[] = [
  { 
    ...
    price: '₹2,500', 
    category: 'Mobility', 
    image: 'https://images.unsplash.com/photo-1623945934241-d602e646ebfb?auto=format&fit=crop&w=800&q=80', 
    tag: 'Best Seller',
  ...
  { 
    ...
    image: 'https://images.unsplash.com/photo-1618519655655-4673f8fb2587?auto=format&fit=crop&w=800&q=80', 
    tag: 'New',
        ...
        >
          {products.map((product) => (
            <motion.div 
              ...
              className={`group relative rounded-3xl overflow-hidden bg-white shadow-sm border border-slate-200 cursor-pointer transition-all duration-300 ${
                  hovered !== null && hovered !== product.id ? 'opacity-40 scale-95 blur-[1px]' : 'opacity-100 scale-100 hover:shadow-2xl hover:border-cyan-200'
              }`}
            >
